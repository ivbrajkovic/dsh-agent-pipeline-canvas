...
The DeepSeek Harness repository at `/Users/Ivan.Brajkovic/Desktop/deepseek-harness` is the reference and source of truth for Harness APIs, services, patterns, and behavior. It is extensively documented. Research it when needed instead of guessing or duplicating Harness knowledge here. **Do not modify the Harness repository.**
