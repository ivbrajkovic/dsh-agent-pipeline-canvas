...
//        the workspace's active run record — running or paused — so a reload
//        discovers it without a list route; `lastRun` is the newest record of
//        any state, null while a run is active — a remounted canvas restores
//        the last run's result from it. Run discovery is still
//        workspace-level; session-scoped run keying is a later phase.)
