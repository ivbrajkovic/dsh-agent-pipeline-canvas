		...
		* cover the open + history replay of the target session. */
		...
		function PipelineView({ sessionId, useSessions, useWorkspaces, inputActions, openView, services, onDismiss }) {
			...
			function controlRunState(control) {
				...
				const firing = node !== void 0 && node.firings.length > 0 ? node.firings[node.firings.length - 1] : void 0;
				if (node === void 0 || firing === void 0) return {
					state: "idle",
					chosen: []
				};
			...
			const edges = connections.map((c) => {
				...
				const edgeState = controlState !== null && (controlState.state === "fired" || controlState.state === "quiet") ? controlState.chosen.indexOf(sourceName) !== -1 ? " pipeline-edge-fired" : " pipeline-edge-quiet" : "";
				const geo = edgeGeometry(s, t);
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("g", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
					d: geo.d,
					className: "pipeline-edge" + edgeState,
			...
			const controlNodes = controls.map((control) => {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						runState !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: "node-status control-status status-" + runState.state,
							title: runState.state === "fired" ? "The decision fired — branch " + runState.chosen.join(", ") : runState.state === "quiet" ? "The feeding agent's result matched no branch — nothing downstream of the if ran" : runState.state === "armed" ? "No branch decision recorded — the feeding agent's last firing never reached emission" : "The run has not reached this decision yet",
							children: runState.state
						}) : null,
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: "pipeline-port in" + (hoveredIn ? " hover" : ""),
							style: {
