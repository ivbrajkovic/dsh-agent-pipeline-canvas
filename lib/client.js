	...
	factory: (require) => {
		...
		*/
		function unresolvedFirings(firings, status) {
			...
			return all.filter((f) => f.status === status && !superseded(f)).sort((a, b) => a.firingId < b.firingId ? -1 : a.firingId > b.firingId ? 1 : 0);
		}
		/**
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							runActive ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								children: activeRun?.state === "paused" ? "Paused at " + nameOf(pausedNodeId) + (queuedCount > 0 ? " +" + queuedCount + " queued" : "") : "Running…"
							}) : null,
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								className: "pipeline-btn",
